      ...
      <div className="container relative z-10 px-6 md:px-8">
        ...
        ease: [0.16, 1, 0.3, 1]
          ...
          delay: 0.6
            ...
            <Button onClick={scrollToWork} size="lg" className="group bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-base font-semibold">
              View Work
              <ArrowDown className="ml-2 w-4 h-4 transition-transform group-hover:translate-y-1" />
            </Button>
            
            <Button asChild variant="outline" size="lg" className="border-border hover:border-primary hover:text-primary px-8 py-6 text-base">
            ...
            <Button asChild variant="outline" size="lg" className="border-border hover:border-primary hover:text-primary px-6 py-6 text-base">
              <a href="https://lnkd.in/gjG-3XdK" target="_blank" rel="noopener noreferrer">
